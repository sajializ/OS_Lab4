...
00000413 <semaphore_initialize>:
SYSCALL(semaphore_initialize)
 413:	b8 16 00 00 00       	mov    $0x16,%eax
 418:	cd 40                	int    $0x40
 41a:	c3                   	ret    

0000041b <semaphore_aquire>:
SYSCALL(semaphore_aquire)
 41b:	b8 17 00 00 00       	mov    $0x17,%eax
 420:	cd 40                	int    $0x40
 422:	c3                   	ret    

00000423 <semaphore_release>:
SYSCALL(semaphore_release)
 423:	b8 18 00 00 00       	mov    $0x18,%eax
 428:	cd 40                	int    $0x40
 42a:	c3                   	ret    

0000042b <inc_counter>:
SYSCALL(inc_counter)
 42b:	b8 28 00 00 00       	mov    $0x28,%eax
 430:	cd 40                	int    $0x40
 432:	c3                   	ret    

00000433 <dec_counter>:
SYSCALL(dec_counter)
 433:	b8 29 00 00 00       	mov    $0x29,%eax
 438:	cd 40                	int    $0x40
 43a:	c3                   	ret    

0000043b <reset_counter>:
SYSCALL(reset_counter)
 43b:	b8 2a 00 00 00       	mov    $0x2a,%eax
 440:	cd 40                	int    $0x40
 442:	c3                   	ret    

00000443 <get_counter>:
 443:	b8 2b 00 00 00       	mov    $0x2b,%eax
 448:	cd 40                	int    $0x40
 44a:	c3                   	ret    
