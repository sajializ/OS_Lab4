...
00000493 <semaphore_initialize>:
SYSCALL(semaphore_initialize)
 493:	b8 16 00 00 00       	mov    $0x16,%eax
 498:	cd 40                	int    $0x40
 49a:	c3                   	ret    

0000049b <semaphore_aquire>:
SYSCALL(semaphore_aquire)
 49b:	b8 17 00 00 00       	mov    $0x17,%eax
 4a0:	cd 40                	int    $0x40
 4a2:	c3                   	ret    

000004a3 <semaphore_release>:
SYSCALL(semaphore_release)
 4a3:	b8 18 00 00 00       	mov    $0x18,%eax
 4a8:	cd 40                	int    $0x40
 4aa:	c3                   	ret    

000004ab <inc_counter>:
SYSCALL(inc_counter)
 4ab:	b8 28 00 00 00       	mov    $0x28,%eax
 4b0:	cd 40                	int    $0x40
 4b2:	c3                   	ret    

000004b3 <dec_counter>:
SYSCALL(dec_counter)
 4b3:	b8 29 00 00 00       	mov    $0x29,%eax
 4b8:	cd 40                	int    $0x40
 4ba:	c3                   	ret    

000004bb <reset_counter>:
SYSCALL(reset_counter)
 4bb:	b8 2a 00 00 00       	mov    $0x2a,%eax
 4c0:	cd 40                	int    $0x40
 4c2:	c3                   	ret    

000004c3 <get_counter>:
 4c3:	b8 2b 00 00 00       	mov    $0x2b,%eax
 4c8:	cd 40                	int    $0x40
 4ca:	c3                   	ret    
