...
00000e33 <semaphore_initialize>:
SYSCALL(semaphore_initialize)
     e33:	b8 16 00 00 00       	mov    $0x16,%eax
     e38:	cd 40                	int    $0x40
     e3a:	c3                   	ret    

00000e3b <semaphore_aquire>:
SYSCALL(semaphore_aquire)
     e3b:	b8 17 00 00 00       	mov    $0x17,%eax
     e40:	cd 40                	int    $0x40
     e42:	c3                   	ret    

00000e43 <semaphore_release>:
SYSCALL(semaphore_release)
     e43:	b8 18 00 00 00       	mov    $0x18,%eax
     e48:	cd 40                	int    $0x40
     e4a:	c3                   	ret    

00000e4b <inc_counter>:
SYSCALL(inc_counter)
     e4b:	b8 28 00 00 00       	mov    $0x28,%eax
     e50:	cd 40                	int    $0x40
     e52:	c3                   	ret    

00000e53 <dec_counter>:
SYSCALL(dec_counter)
     e53:	b8 29 00 00 00       	mov    $0x29,%eax
     e58:	cd 40                	int    $0x40
     e5a:	c3                   	ret    

00000e5b <reset_counter>:
SYSCALL(reset_counter)
     e5b:	b8 2a 00 00 00       	mov    $0x2a,%eax
     e60:	cd 40                	int    $0x40
     e62:	c3                   	ret    

00000e63 <get_counter>:
     e63:	b8 2b 00 00 00       	mov    $0x2b,%eax
     e68:	cd 40                	int    $0x40
     e6a:	c3                   	ret    
