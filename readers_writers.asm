...
_readers_writers:     file format elf32-i386
...
main(int argc, char *argv[]){
  ...
  readers_writers();
   a:	e8 11 00 00 00       	call   20 <readers_writers>
  exit();
...
readers_writers(){
  ...
  reset_counter();
  2d:	e8 99 03 00 00       	call   3cb <reset_counter>
  for (int i = 0; i < 6; i++){
  32:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      int pid = fork();
  38:	e8 be 02 00 00       	call   2fb <fork>
      if (pid == 0){
  3d:	89 da                	mov    %ebx,%edx
  3f:	83 c3 01             	add    $0x1,%ebx
  42:	85 c0                	test   %eax,%eax
  44:	74 27                	je     6d <readers_writers+0x4d>
  for (int i = 0; i < 6; i++){
  46:	83 fb 06             	cmp    $0x6,%ebx
  49:	75 ed                	jne    38 <readers_writers+0x18>
    wait();
  4b:	e8 bb 02 00 00       	call   30b <wait>
  50:	e8 b6 02 00 00       	call   30b <wait>
  55:	e8 b1 02 00 00       	call   30b <wait>
  5a:	e8 ac 02 00 00       	call   30b <wait>
  5f:	e8 a7 02 00 00       	call   30b <wait>
}
  64:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  67:	c9                   	leave  
    wait();
  68:	e9 9e 02 00 00       	jmp    30b <wait>
        if (i == 0 || i == 4){
  6d:	83 e2 fb             	and    $0xfffffffb,%edx
  70:	74 16                	je     88 <readers_writers+0x68>
            printf(1, "Child %d Executing as a reader\n", i + 1);
  72:	50                   	push   %eax
  73:	53                   	push   %ebx
  74:	68 18 08 00 00       	push   $0x818
  79:	6a 01                	push   $0x1
  7b:	e8 10 04 00 00       	call   490 <printf>
  80:	83 c4 10             	add    $0x10,%esp
        exit();
  83:	e8 7b 02 00 00       	call   303 <exit>
            printf(1, "Child %d Executing as a writer\n", i + 1);
  88:	83 ec 04             	sub    $0x4,%esp
  8b:	53                   	push   %ebx
  8c:	68 f8 07 00 00       	push   $0x7f8
  91:	6a 01                	push   $0x1
  93:	e8 f8 03 00 00       	call   490 <printf>
  98:	83 c4 10             	add    $0x10,%esp
  9b:	eb e6                	jmp    83 <readers_writers+0x63>
  9d:	66 90                	xchg   %ax,%ax
  9f:	90                   	nop
...
000003a3 <semaphore_initialize>:
SYSCALL(semaphore_initialize)
 3a3:	b8 16 00 00 00       	mov    $0x16,%eax
 3a8:	cd 40                	int    $0x40
 3aa:	c3                   	ret    

000003ab <semaphore_aquire>:
SYSCALL(semaphore_aquire)
 3ab:	b8 17 00 00 00       	mov    $0x17,%eax
 3b0:	cd 40                	int    $0x40
 3b2:	c3                   	ret    

000003b3 <semaphore_release>:
SYSCALL(semaphore_release)
 3b3:	b8 18 00 00 00       	mov    $0x18,%eax
 3b8:	cd 40                	int    $0x40
 3ba:	c3                   	ret    

000003bb <inc_counter>:
SYSCALL(inc_counter)
 3bb:	b8 28 00 00 00       	mov    $0x28,%eax
 3c0:	cd 40                	int    $0x40
 3c2:	c3                   	ret    

000003c3 <dec_counter>:
SYSCALL(dec_counter)
 3c3:	b8 29 00 00 00       	mov    $0x29,%eax
 3c8:	cd 40                	int    $0x40
 3ca:	c3                   	ret    

000003cb <reset_counter>:
SYSCALL(reset_counter)
 3cb:	b8 2a 00 00 00       	mov    $0x2a,%eax
 3d0:	cd 40                	int    $0x40
 3d2:	c3                   	ret    

000003d3 <get_counter>:
 3d3:	b8 2b 00 00 00       	mov    $0x2b,%eax
 3d8:	cd 40                	int    $0x40
 3da:	c3                   	ret    
...
printf(int fd, const char *fmt, ...)
{
 ...
 614:	eb 1a                	jmp    630 <printf+0x1a0>
          s = "(null)";
 616:	bb 38 08 00 00       	mov    $0x838,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 665:	a1 08 0b 00 00       	mov    0xb08,%eax
{
 ...
 686:	73 10                	jae    698 <free+0x38>
{
 ...
 6b1:	5b                   	pop    %ebx
  freep = p;
 6b2:	a3 08 0b 00 00       	mov    %eax,0xb08
}
 6b7:	5e                   	pop    %esi
 6b8:	5f                   	pop    %edi
 6b9:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 6fd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 700:	8b 3d 08 0b 00 00    	mov    0xb08,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 749:	8b 3d 08 0b 00 00    	mov    0xb08,%edi
 ...
 772:	e8 e9 fe ff ff       	call   660 <free>
  return freep;
 777:	a1 08 0b 00 00       	mov    0xb08,%eax
 ...
 7a4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 7a7:	a3 08 0b 00 00       	mov    %eax,0xb08
}
