...
00000333 <semaphore_initialize>:
SYSCALL(semaphore_initialize)
 333:	b8 16 00 00 00       	mov    $0x16,%eax
 338:	cd 40                	int    $0x40
 33a:	c3                   	ret    

0000033b <semaphore_aquire>:
SYSCALL(semaphore_aquire)
 33b:	b8 17 00 00 00       	mov    $0x17,%eax
 340:	cd 40                	int    $0x40
 342:	c3                   	ret    

00000343 <semaphore_release>:
SYSCALL(semaphore_release)
 343:	b8 18 00 00 00       	mov    $0x18,%eax
 348:	cd 40                	int    $0x40
 34a:	c3                   	ret    

0000034b <inc_counter>:
SYSCALL(inc_counter)
 34b:	b8 28 00 00 00       	mov    $0x28,%eax
 350:	cd 40                	int    $0x40
 352:	c3                   	ret    

00000353 <dec_counter>:
SYSCALL(dec_counter)
 353:	b8 29 00 00 00       	mov    $0x29,%eax
 358:	cd 40                	int    $0x40
 35a:	c3                   	ret    

0000035b <reset_counter>:
SYSCALL(reset_counter)
 35b:	b8 2a 00 00 00       	mov    $0x2a,%eax
 360:	cd 40                	int    $0x40
 362:	c3                   	ret    

00000363 <get_counter>:
 363:	b8 2b 00 00 00       	mov    $0x2b,%eax
 368:	cd 40                	int    $0x40
 36a:	c3                   	ret    
