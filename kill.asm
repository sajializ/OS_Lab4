...
00000373 <semaphore_initialize>:
SYSCALL(semaphore_initialize)
 373:	b8 16 00 00 00       	mov    $0x16,%eax
 378:	cd 40                	int    $0x40
 37a:	c3                   	ret    

0000037b <semaphore_aquire>:
SYSCALL(semaphore_aquire)
 37b:	b8 17 00 00 00       	mov    $0x17,%eax
 380:	cd 40                	int    $0x40
 382:	c3                   	ret    

00000383 <semaphore_release>:
SYSCALL(semaphore_release)
 383:	b8 18 00 00 00       	mov    $0x18,%eax
 388:	cd 40                	int    $0x40
 38a:	c3                   	ret    

0000038b <inc_counter>:
SYSCALL(inc_counter)
 38b:	b8 28 00 00 00       	mov    $0x28,%eax
 390:	cd 40                	int    $0x40
 392:	c3                   	ret    

00000393 <dec_counter>:
SYSCALL(dec_counter)
 393:	b8 29 00 00 00       	mov    $0x29,%eax
 398:	cd 40                	int    $0x40
 39a:	c3                   	ret    

0000039b <reset_counter>:
SYSCALL(reset_counter)
 39b:	b8 2a 00 00 00       	mov    $0x2a,%eax
 3a0:	cd 40                	int    $0x40
 3a2:	c3                   	ret    

000003a3 <get_counter>:
 3a3:	b8 2b 00 00 00       	mov    $0x2b,%eax
 3a8:	cd 40                	int    $0x40
 3aa:	c3                   	ret    
