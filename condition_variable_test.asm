...
_condition_variable_test:     file format elf32-i386
...
test(){
  ...
  31:	78 35                	js     68 <test+0x48>
  else if (pid == 0){
  33:	74 1b                	je     50 <test+0x30>
    int pid = fork();
  35:	e8 c1 02 00 00       	call   2fb <fork>
    if (pid < 0){
  3a:	85 c0                	test   %eax,%eax
  3c:	78 2a                	js     68 <test+0x48>
    else if (pid == 0){
  3e:	74 40                	je     80 <test+0x60>
        wait();
  40:	e8 c6 02 00 00       	call   30b <wait>
}
  45:	c9                   	leave  
        wait();
  46:	e9 c0 02 00 00       	jmp    30b <wait>
  4b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  4f:	90                   	nop
    printf(1, "Child 1 Executing\n");
  50:	83 ec 08             	sub    $0x8,%esp
  53:	68 14 08 00 00       	push   $0x814
  58:	6a 01                	push   $0x1
 ...
 3ec:	89 d1                	mov    %edx,%ecx
{
 ...
 419:	0f b6 92 44 08 00 00 	movzbl 0x844(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 614:	eb 1a                	jmp    630 <printf+0x1a0>
          s = "(null)";
 616:	bb 3a 08 00 00       	mov    $0x83a,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 665:	a1 1c 0b 00 00       	mov    0xb1c,%eax
{
 ...
 686:	73 10                	jae    698 <free+0x38>
{
 ...
 6b1:	5b                   	pop    %ebx
  freep = p;
 6b2:	a3 1c 0b 00 00       	mov    %eax,0xb1c
}
 6b7:	5e                   	pop    %esi
 6b8:	5f                   	pop    %edi
 6b9:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 6fd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 700:	8b 3d 1c 0b 00 00    	mov    0xb1c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 749:	8b 3d 1c 0b 00 00    	mov    0xb1c,%edi
 ...
 772:	e8 e9 fe ff ff       	call   660 <free>
  return freep;
 777:	a1 1c 0b 00 00       	mov    0xb1c,%eax
 ...
 7a4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 7a7:	a3 1c 0b 00 00       	mov    %eax,0xb1c
}
 ...
 7c7:	0b 00 00 
    base.s.size = 0;
 7ca:	bf 20 0b 00 00       	mov    $0xb20,%edi
    base.s.ptr = freep = prevp = &base;
 7cf:	c7 05 20 0b 00 00 20 	movl   $0xb20,0xb20
 7d6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7d9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7db:	c7 05 24 0b 00 00 00 	movl   $0x0,0xb24
 7e2:	00 00 00 
    if(p->s.size >= nunits){
