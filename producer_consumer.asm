...
main(int argc, char *argv[])
{
  ...
  13:	6a 01                	push   $0x1
  15:	6a 01                	push   $0x1
  17:	e8 46 03 00 00       	call   362 <semaphore_initialize>
  fork();
  1c:	e8 99 02 00 00       	call   2ba <fork>
  fork();
  21:	e8 94 02 00 00       	call   2ba <fork>
  semaphore_aquire(1);
  26:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  2d:	e8 38 03 00 00       	call   36a <semaphore_aquire>
  printf(2, "salaaaaaaaaaam\n");
  32:	58                   	pop    %eax
  33:	5a                   	pop    %edx
  34:	68 78 07 00 00       	push   $0x778
  39:	6a 02                	push   $0x2
  3b:	e8 e0 03 00 00       	call   420 <printf>
  sleep(100);
  40:	c7 04 24 64 00 00 00 	movl   $0x64,(%esp)
  47:	e8 06 03 00 00       	call   352 <sleep>
  semaphore_release(1);
  4c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  53:	e8 1a 03 00 00       	call   372 <semaphore_release>
  wait();
  58:	e8 6d 02 00 00       	call   2ca <wait>
  wait();  
  5d:	e8 68 02 00 00       	call   2ca <wait>
  exit();
  62:	e8 5b 02 00 00       	call   2c2 <exit>
  67:	66 90                	xchg   %ax,%ax
  69:	66 90                	xchg   %ax,%ax
  6b:	66 90                	xchg   %ax,%ax
  6d:	66 90                	xchg   %ax,%ax
...
printf(int fd, const char *fmt, ...)
{
 ...
 5d4:	e9 8f fe ff ff       	jmp    468 <printf+0x48>
          s = "(null)";
 5d9:	bb 88 07 00 00       	mov    $0x788,%ebx
        while(*s != 0){
