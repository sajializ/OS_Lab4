...
000003f3 <semaphore_initialize>:
SYSCALL(semaphore_initialize)
 3f3:	b8 16 00 00 00       	mov    $0x16,%eax
 3f8:	cd 40                	int    $0x40
 3fa:	c3                   	ret    

000003fb <semaphore_aquire>:
SYSCALL(semaphore_aquire)
 3fb:	b8 17 00 00 00       	mov    $0x17,%eax
 400:	cd 40                	int    $0x40
 402:	c3                   	ret    

00000403 <semaphore_release>:
SYSCALL(semaphore_release)
 403:	b8 18 00 00 00       	mov    $0x18,%eax
 408:	cd 40                	int    $0x40
 40a:	c3                   	ret    

0000040b <inc_counter>:
SYSCALL(inc_counter)
 40b:	b8 28 00 00 00       	mov    $0x28,%eax
 410:	cd 40                	int    $0x40
 412:	c3                   	ret    

00000413 <dec_counter>:
SYSCALL(dec_counter)
 413:	b8 29 00 00 00       	mov    $0x29,%eax
 418:	cd 40                	int    $0x40
 41a:	c3                   	ret    

0000041b <reset_counter>:
SYSCALL(reset_counter)
 41b:	b8 2a 00 00 00       	mov    $0x2a,%eax
 420:	cd 40                	int    $0x40
 422:	c3                   	ret    

00000423 <get_counter>:
 423:	b8 2b 00 00 00       	mov    $0x2b,%eax
 428:	cd 40                	int    $0x40
 42a:	c3                   	ret    
