...
00000643 <semaphore_initialize>:
SYSCALL(semaphore_initialize)
 643:	b8 16 00 00 00       	mov    $0x16,%eax
 648:	cd 40                	int    $0x40
 64a:	c3                   	ret    

0000064b <semaphore_aquire>:
SYSCALL(semaphore_aquire)
 64b:	b8 17 00 00 00       	mov    $0x17,%eax
 650:	cd 40                	int    $0x40
 652:	c3                   	ret    

00000653 <semaphore_release>:
SYSCALL(semaphore_release)
 653:	b8 18 00 00 00       	mov    $0x18,%eax
 658:	cd 40                	int    $0x40
 65a:	c3                   	ret    

0000065b <inc_counter>:
SYSCALL(inc_counter)
 65b:	b8 28 00 00 00       	mov    $0x28,%eax
 660:	cd 40                	int    $0x40
 662:	c3                   	ret    

00000663 <dec_counter>:
SYSCALL(dec_counter)
 663:	b8 29 00 00 00       	mov    $0x29,%eax
 668:	cd 40                	int    $0x40
 66a:	c3                   	ret    

0000066b <reset_counter>:
SYSCALL(reset_counter)
 66b:	b8 2a 00 00 00       	mov    $0x2a,%eax
 670:	cd 40                	int    $0x40
 672:	c3                   	ret    

00000673 <get_counter>:
 673:	b8 2b 00 00 00       	mov    $0x2b,%eax
 678:	cd 40                	int    $0x40
 67a:	c3                   	ret    
