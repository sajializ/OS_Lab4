...
00000443 <semaphore_initialize>:
SYSCALL(semaphore_initialize)
 443:	b8 16 00 00 00       	mov    $0x16,%eax
 448:	cd 40                	int    $0x40
 44a:	c3                   	ret    

0000044b <semaphore_aquire>:
SYSCALL(semaphore_aquire)
 44b:	b8 17 00 00 00       	mov    $0x17,%eax
 450:	cd 40                	int    $0x40
 452:	c3                   	ret    

00000453 <semaphore_release>:
SYSCALL(semaphore_release)
 453:	b8 18 00 00 00       	mov    $0x18,%eax
 458:	cd 40                	int    $0x40
 45a:	c3                   	ret    

0000045b <inc_counter>:
SYSCALL(inc_counter)
 45b:	b8 28 00 00 00       	mov    $0x28,%eax
 460:	cd 40                	int    $0x40
 462:	c3                   	ret    

00000463 <dec_counter>:
SYSCALL(dec_counter)
 463:	b8 29 00 00 00       	mov    $0x29,%eax
 468:	cd 40                	int    $0x40
 46a:	c3                   	ret    

0000046b <reset_counter>:
SYSCALL(reset_counter)
 46b:	b8 2a 00 00 00       	mov    $0x2a,%eax
 470:	cd 40                	int    $0x40
 472:	c3                   	ret    

00000473 <get_counter>:
 473:	b8 2b 00 00 00       	mov    $0x2b,%eax
 478:	cd 40                	int    $0x40
 47a:	c3                   	ret    
