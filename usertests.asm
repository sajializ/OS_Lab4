...
00003a23 <semaphore_initialize>:
SYSCALL(semaphore_initialize)
    3a23:	b8 16 00 00 00       	mov    $0x16,%eax
    3a28:	cd 40                	int    $0x40
    3a2a:	c3                   	ret    

00003a2b <semaphore_aquire>:
SYSCALL(semaphore_aquire)
    3a2b:	b8 17 00 00 00       	mov    $0x17,%eax
    3a30:	cd 40                	int    $0x40
    3a32:	c3                   	ret    

00003a33 <semaphore_release>:
SYSCALL(semaphore_release)
    3a33:	b8 18 00 00 00       	mov    $0x18,%eax
    3a38:	cd 40                	int    $0x40
    3a3a:	c3                   	ret    

00003a3b <inc_counter>:
SYSCALL(inc_counter)
    3a3b:	b8 28 00 00 00       	mov    $0x28,%eax
    3a40:	cd 40                	int    $0x40
    3a42:	c3                   	ret    

00003a43 <dec_counter>:
SYSCALL(dec_counter)
    3a43:	b8 29 00 00 00       	mov    $0x29,%eax
    3a48:	cd 40                	int    $0x40
    3a4a:	c3                   	ret    

00003a4b <reset_counter>:
SYSCALL(reset_counter)
    3a4b:	b8 2a 00 00 00       	mov    $0x2a,%eax
    3a50:	cd 40                	int    $0x40
    3a52:	c3                   	ret    

00003a53 <get_counter>:
    3a53:	b8 2b 00 00 00       	mov    $0x2b,%eax
    3a58:	cd 40                	int    $0x40
    3a5a:	c3                   	ret    
